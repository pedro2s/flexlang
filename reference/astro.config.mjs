    ...
    starlight({
      ...
      sidebar: [
        ...
        },
        {
          ...
          items: [
            { label: 'net/http — Servidores REST', slug: 'stdlib/http', translations: { en: 'net/http — REST Servers' } },
            { label: 'db/postgres — Driver PostgreSQL', slug: 'stdlib/postgres', translations: { en: 'db/postgres — PostgreSQL Driver' } },
            { label: 'math/decimal — Aritmética Exata', slug: 'stdlib/decimal', translations: { en: 'math/decimal — Arbitrary Precision' } },
            ...
            { label: 'os/env — Variáveis de Ambiente', slug: 'stdlib/env', translations: { en: 'os/env — Environment Variables' } },
        ...
        },
        {
          ...
          items: [
            { label: 'Comandos da CLI', slug: 'cli/commands', translations: { en: 'CLI Commands' } },
