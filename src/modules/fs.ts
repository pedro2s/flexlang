  ...
  types: [
    {
      name: "fs",
      statics: [
        { name: "read_to_string", arity: 1, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "String" }, { kind: "String" }] } },
        { name: "write_string", arity: 2, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "String" }, { kind: "String" }] } },
        { name: "append_string", arity: 2, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "String" }, { kind: "String" }] } },
        { name: "exists", arity: 1, returns: { kind: "Bool" } },
        { name: "is_file", arity: 1, returns: { kind: "Bool" } },
        { name: "is_dir", arity: 1, returns: { kind: "Bool" } },
        { name: "create_dir_all", arity: 1, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "String" }, { kind: "String" }] } },
        { name: "read_dir", arity: 1, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "Array", elementType: { kind: "String" } }, { kind: "String" }] } },
        { name: "remove_file", arity: 1, returns: { kind: "Enum", name: "Result", genericArgs: [{ kind: "String" }, { kind: "String" }] } },
      ],
      methods: [],
    },
  ],
