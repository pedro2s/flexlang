...
1. **Walkthrough da Implementação**: Você deve OBRIGATORIAMENTE salvar o artefato `walkthrough` que descreve o que foi modificado e as decisões tomadas dentro do diretório do projeto para memória de longo prazo.
